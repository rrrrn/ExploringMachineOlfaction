...
import torch
from datamodule.datasets.dravnieks_dataset import DravTranferDataset
from datamodule.datasets.kellerdataset import KellerTransferDataset
import pandas as pd
...
def learn_embeddings(datasetname, model = "GCN2Regressor") :
    ...
    if datasetname == "keller":
        gnnname = "1440"
        dataset = KellerTransferDataset(transfer="all")
    else:
        gnnname = "1413"
        dataset = DravTranferDataset(transfer="all")
